...
## Premisa
Belu, Gian y Rosa se van de vacaciones a **Isla Pato**. Todo hermoso… hasta que
aparece el barco pirata **"El Pato Mareado"** y **secuestran a Gian**. Belu (con
Rosa) tiene que cruzar el archipiélago, superar desafíos de parkour y llegar a la
...
- **Rosa** — gata blanca y negra, compañera fiel. Olfatea el rastro, trepa por las rocas,
  distrae/araña piratas (comedia). (modelo chibi ya hecho)
...
## Intro (cutscene)
Playa paradisíaca. Belu saca fotos, Rosa juguetea. Gian: *"voy a explorar un toque"* 🧭,
se aleja, se pierde tras unas rocas, y **¡zácate!** la tripulación de Lulu lo mete en
un saco. Rosa maúlla, Belu se da vuelta y ve "El Pato Mareado" zarpando con Gian en una
...
- **Ovillos de Rosa** 🧶, cofres, barriles, cañones, banderas, catalejo, brújula,
  loro, sombreros piratas.
- **Fotos-recuerdo** (polaroids con fotos reales de `img/`) — pocos toques tiernos.

## Mecánicas
- **Rosa compañera:** te sigue, olfatea el rastro, trepa, distrae piratas.
...
- **Conflicto NO violento** (slapstick): a los piratas los esquivás o los noquea
  Rosa / un cocazo 🥥. Sin sangre, puro chiste.
