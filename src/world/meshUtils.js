...
// forman triángulos. opts.colors: vertex-colors (mismo largo); opts.flat: flatShading.
// Se usa para el terreno de las islas y para props con geometría propia (sombrilla).
